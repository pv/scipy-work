...
def leastsq(func, x0, args=(), Dfun=None, full_output=0,
    ...
    bounds : sequence of tuples
        Bounds for the parameters, as a sequence of lower and upper bounds,
        ``[(x_low[0], x_high[0]), ..., (x_low[n], x_high[n])]``.
    ...
    When bounds are given for the parameters, the limits are implemented via
    nonlinear transformations to 
