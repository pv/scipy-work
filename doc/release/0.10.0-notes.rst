...
Optimization in convex set (``scipy.optimize``)
-----------------------------------------------

The function ``scipy.optimize.fmin_bfgs`` can now handle functions
that are finite only in a convex set and infinite outside the set.
